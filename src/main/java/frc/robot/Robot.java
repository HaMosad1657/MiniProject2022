...
public class Robot extends TimedRobot {
	...
	// Note that the "Robot Code" mark in the Driver Station won't show green until
	// robotInit() is done.
	@Override
	...
	public void autonomousInit() {
		// this.autoCommand =
		// this.robotContainer.getAutoCommand(AutoCommand.kFollowJSONTrajectory);
		// this.commandScheduler.schedule(this.autoCommand); // schedule() only needs to
		// be called once
	}
